...
+ $+ may_t (1-x_t)$ -- describes infection of uninfected humans: the fraction of humans who are not infected is $1-x_t$; a fraction $m a y_t$ gets infected. (If $may_t >1,$ the term does not make sense. In sub-section \@ref(dtsRoss2), below, we discuss this in greater depth.)
