...
Ronald Ross is best known for being the first person to observe malaria parasites infecting the midgut of a mosquito [@RossR1897PeculiarPigmented]. 
The day the event occurred is now celebrated each August 20, called _mosquito day_.
In his next paper, Ross presented evidence that mosquitoes transmit the parasites to humans, a step that was required to prove that the parasites could cause malaria [@RossR1898RoleMosquito].
...
Ross and Grassi had closed a loop that Charles Laveran opened in 1880, which was the original discovery of malaria parasites infecting humans [@Laveran1880;@Laveran1884].
After Laveran, several studies described basic features of malaria infections in humans [@GarnhamPCC1988HistoryDiscoveries]. 
These discoveries and studies set the stage for the modern study of malaria epidemiology, and in 1902, Ross was awarded the Nobel Prize for Physiology or Medicine.
