...
Ronald Ross is best known for being the first person to observe malaria parasites in a mosquito, infecting its midgut [@RossR1897PeculiarPigmented], an event that is now celebrated each August 20, called _mosquito day_.
...
Ross and Grassi had closed a loop that Charles Laveran opened in 1880 when he published his discovery of malaria parasites infecting humans [@Laveran1880;@Laveran1884].
...
While that story that is of great interest, this book on **Applied Malaria Dynamics** is about the use mathematics, especially dynamical systems, to study malaria epidemiology, transmission dynamics, and control. This brings us back to Ronald Ross, who -- in the later stages of his career -- turned his attention to the prevention of malaria and the study of epidemics. 
...
Ross became a key player in the early days of malaria research, initiating studies of all sorts in malaria epidemiology and control [@BockarieMJ1999ItAll;@SmithDL2012_RossMacdonald]. 
...
Despite these heroic efforts, the work by Ross and Hudson on _a priori pathometry_ was missing a key element in the modern mathematical study of epidemics. This appeared in 1920, published by Martini, in the form of a new mathematical model, in which recovery from infection was followed by lifelong immunity. 
...
after Ross published the equations in Nature in 1911 [@RossR1911Nature], Alfred Lotka published a closed-form solution in 1912 [@LotkaAJ1912Nature]. 
