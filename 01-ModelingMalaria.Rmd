...
# Ross and the Prevention of Malaria 

Ronald Ross is best known for being the first person to observe malaria parasites in a mosquito [@RossR1897PeculiarPigmented] on August 20$^{th}$, 1897, celebrated as _mosquito day_.
In the months that followed, Ross presented evidence that mosquitoes transmit malaria parasites. 
...
Malaria was commonly treated with quinine after the compound was isolated in 1824, long before Laveran.
...
After the big discovery, Ross turned his attention to malaria control, and by 1910,
he published *The Prevention of Malaria,* which was followed by a $2^{nd}$ edition in 1911.
Ross is of interest because he takes a quantitative approach to the prevention of malaria.
...
In the last phase of his career, Ross formed an alliance with Hilda Hudson, a mathematics professor from Cambridge University. Ross and Hudson developed mathematical theory to support the study of epidemics, which they called *a priori pathometry.*  

The parasite life-cycle has been an organizing principle for the study of malaria. 
The discoveries by Laveran, Ross, Battista Grassi, Garnham and others set the stage for hundreds of thousands of studies over 144 years that have developed a rich and impressive body of knowledge. 
...
The book has a narrower focus. 
It is designed as a a primer to support robust analytics for malaria policy (RAMP).
It is designed to cover malaria epidemiology, transmission dynamics and control, and some closely related topics (*e.g.* mosquito ecology and human demograph) to support the development of simulation-based analytics for malaria policy. 
...
The goal of malaria control is to prevent malaria.
Since malaria is a mosquito-transmitted diseases, malaria control programs need some basic theory to understand how malaria (*i.e.* any disease that is caused by infection with the parasite) and the prevalence of infection are related to malaria transmission by mosquitoes.
In particular, it should be able to relate the factors driving malaria in a place, the metrics that we use to measure malaria, mosquito population densities and bionomics, and the actions taken by malaria control programs.
Ross was not the only one to grapple with the complex, multi-factorial nature of malaria transmission and vector control, but what set him apart was his use of mathematics to illustrate his ideas to malaria. 
(At the end of this chapter, we make some attempt to put Ross into a broader historical narrative.)

*** 

In 1899, Ross launched a new phase of his career that focused on the prevention of malaria in a pair of essays that discussed the possibility of *exterminating* or *extirpating* malaria through mosquito control  [@RossR1899ExterminationMalaria;@RossR1899InauguralLecture]. Ross's initial focus was on larval source management: 
...
Over the decade, Ross began to use quantitative concepts to understand some very basic questions. Among Ross's writing, we find a question posed in 1902, in *Mosquito Brigades and How to Organise Them* [@RossR1902MosquitoBrigades]: 
...
Ross was thus trying to develop some kind of quantitative logic to help set reasonable expectations about the responses to mosquito control. His guess was that the responses should be non-linear because two bites are required for transmission -- one to infect a mosquito and another to transmit it back to humans. In paragraph that follows, Ross explains what he meant by a *duplicate ratio.* 
...
While Ross was right that there should be a non-linearity, his quantitative logic failed when he tried to use it without going the rigorous process of developing and analyzing a mathematical model. Using mathematical models, we would now argue that, in fact, the expected reduction varies from place to place, depending on the intensity of transmission, which scales linearly with the density of mosquitoes. When transmission is very intense, halving mosquitoes would scarcely change the fraction of humans infected. In some places, halving mosquitoes might be enough to end malaria transmission. 


Despite getting the logic wrong, Ross was asking relevant questions about *scaling relationships* in malaria transmission and their causes.
