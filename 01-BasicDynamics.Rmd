...
In fact, 
$$\frac{H-X}{H + cSX} \lapprox 1$$ 


$$\frac{1}{r} \frac{dX}{dt} \approx X \left( R_0  - 1\right)$$ 
It follows that if $R_0 >1$, then $X$ will tend to increase. 
