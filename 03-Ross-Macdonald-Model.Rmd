...
***The Ross-Macdonald Model** as systems of delay differential equations -- George Macdonald's broader understanding of malaria transmission.* 

*** 

When I first learned about malaria, the basic model was commonly called the *Ross-Macdonald Model.*
A few years ago, I went searching for *The Ross-Macdonald Model* with the hope of getting a clear answer about how and why George Macdonald's name had attached.
...
I finally found the equations in a concise form in publications from 1982   [@AronJL1982PopulationDynamics;@BaileyNTJ1982BiomathematicsMalaria]. 

Macdonald published XX papers on a range of topics in malaria epidemiology, transmission dynamics and control between 1950 and 1956. 
The papers were followed by a book in 1957, called *The Epidemiology and Control of Malaria.* 
...
The paper on superinfection is flawed [@FinePEM1975SuperinfectionProblem].
