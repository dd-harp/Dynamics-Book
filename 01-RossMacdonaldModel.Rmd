...
Ross noted the differences in malaria prevalence, which he attributed to differences in exposure to infectious mosquitoes. He knew that the level of prevalence was related to local mosquito populations, but he also recognized that malaria could be acquired elsewhere (*e.g.* while traveling). 
