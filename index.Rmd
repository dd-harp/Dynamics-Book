...
Policy discussions might benefit from using mathematics, but the discussion should focus on the policy questions, the concepts, and evidence rather than on the mathematics *per se*. 
Ideally, mathematical ideas should give rigor to the analysis help structure the discussions without ever drawing attention to itself, except when mathematics could help to clarify something.
