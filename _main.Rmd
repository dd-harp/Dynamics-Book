...
Ronald Ross is best known for being the first person to observe malaria parasites in a mosquito [@RossR1897PeculiarPigmented]. The event, which occurred in a military hospital in Hyderabad, India on August 20$^{th}$, 1897, is now celebrated as _mosquito day_.
...
<!--chapter:end:01-ModelingMalaria.Rmd-->
...
1. The two models we just presented above can be implemented in a spreadsheet.  
...
<!--chapter:end:02-BasicDynamics.Rmd-->
...
<!--chapter:end:03-MacdonaldModel.Rmd-->
...
<!--chapter:end:04-MalariaMetrics.Rmd-->
...
<!--chapter:end:05-MalariaControl.Rmd-->
...
<!--chapter:end:10-ModelBuilding.Rmd-->
...
<!--chapter:end:11-AdultMosquitoDynamics.Rmd-->

# Blood Feeding

## 

<!--chapter:end:12-BloodFeeding.Rmd-->
...
<!--chapter:end:13-MosquitoEcology.Rmd-->
...
<!--chapter:end:14-HumanAgeDemography.Rmd-->
...
<!--chapter:end:18-ModularComputation.Rmd-->
...
<!--chapter:end:20-MalariaEpidemiology.Rmd-->
...
<!--chapter:end:22-Superinfection.Rmd-->
...
<!--chapter:end:26-Gametocytes.Rmd-->

# Care Seeking

<!--chapter:end:27-CohortDynamics.Rmd-->

# Modeling Malaria Epidemiology

## 

<!--chapter:end:29-ModelingMalaria.Rmd-->
...
<!--chapter:end:30-Transmission.Rmd-->
...
<!--chapter:end:31-HumanMobility.Rmd-->

# Spatial Dynamics

<!--chapter:end:32-SpatialDynamics.Rmd-->
...
<!--chapter:end:34-HeterogeneousTransmission.Rmd-->
...
<!--chapter:end:40-Mosquitoes.Rmd-->

# Behavioral State Models

<!--chapter:end:41-BehavioralStates.Rmd-->

# Mosquito Dispersal

<!--chapter:end:42-MosquitoDispersal.Rmd-->

# Aquatic Ecology

<!--chapter:end:43-AquaticDynamics.Rmd-->
...
<!--chapter:end:44-ExogenousForcing.Rmd-->

# Multi-Species Models 

## Vector Competence 

<!--chapter:end:46-MultipleVectors.Rmd-->

# Measuring Mosquitoes


<!--chapter:end:47-MeasuringMosquitoes.Rmd-->
...
<!--chapter:end:50-VectorControl.Rmd-->

# Insecticide-Treated Bednets

<!--chapter:end:51-ITN.Rmd-->

# Indoor Residual Spraying

<!--chapter:end:52-IRS.Rmd-->

# Larval Source Management 

<!--chapter:end:53-LSM.Rmd-->

# Attractive Toxic Sugar Baits

<!--chapter:end:54-ATSB.Rmd-->

# Integrated Vector Control

<!--chapter:end:59-IntegratedVectorControl.Rmd-->

# (PART) Health Systems {-}

<!--chapter:end:60-Humans.Rmd-->
...
<!--chapter:end:61-CareSeeking.Rmd-->
...
<!--chapter:end:62-Demography.Rmd-->

# Human Travel and Malaria Importation

<!--chapter:end:63-Travel.Rmd-->

# Stratification 

<!--chapter:end:65-Stratification.Rmd-->
...
<!--chapter:end:66-Pharmaceuticals.Rmd-->
...
<!--chapter:end:70-MalariaAnalytics.Rmd-->
...
<!--chapter:end:71-MalariaMetrics.Rmd-->

# Discrete Time 



<!--chapter:end:72-Scaling.Rmd-->

# Spatial Concepts and Connectivity

<!--chapter:end:73-Connectivity.Rmd-->

# Mosquito Microecology

Modeling mosquito population dynamics on point sets. 

<!--chapter:end:74-Microecology.Rmd-->

# Microsimulation

<!--chapter:end:75-Microsimulation.Rmd-->

# Spatial Control

<!--chapter:end:76-SpatialControl.Rmd-->

# Model Libraries

<!--chapter:end:80-ModelLibraries.Rmd-->

# Base Models

<!--chapter:end:81-BaseModels.Rmd-->

# Built-in Analytics

<!--chapter:end:84-BuiltInAnalytics.Rmd-->

# Stochasticity 

<!--chapter:end:85-Stochasticity.Rmd-->
